    ...
    <>
      ...
      <div className="fixed bottom-6 right-6 z-50">
        <Button
          ...
          className={`${
            isOpen ? 'hidden' : 'flex'
          } w-16 h-16 rounded-full temple-gradient hover:scale-110 transition-all duration-300 shadow-2xl hover:shadow-3xl group ${
            isMobile ? 'w-14 h-14' : ''
          }`}
        >
      ...
      {isOpen && (
        <div className={`fixed z-50 ${
          ...
          } flex flex-col shadow-2xl border-2 border-primary/20 animate-scale-in`}>
